...
<g clip-path="url(#activityFrame)">
  ...
  <rect x="26" y="18" width="1128" height="176" rx="12"
        fill="{card}" stroke="{card_border}"/>
  <line x1="402.67" y1="54" x2="402.67" y2="176" stroke="{divider}"/>
  <line x1="777.33" y1="54" x2="777.33" y2="176" stroke="{divider}"/>

  <!-- ACTIVE DAYS -->
  <g transform="translate(214.67 42) scale(0.78)">
  ...
  <!-- LONGEST STREAK -->
  <g transform="translate(965.33 42) scale(0.78)">
...
'''.strip()]
    ...
    snake = snake_body()
    if snake:
        p.append(f'<g transform="translate(42 486.3) scale(1.2818 0.8854)">{snake}</g>')
    else:
